...
import com.francisco.cliente.e_commerceapp.databinding.ActivityInicioBinding;
...
public class InicioActivity extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        if (usuarioJson != null) {
            ...
            String url = ConfigApi.baseUrlE + "/api/documento-almacenado/download/" + u.getCliente().getFoto().getCompleteFileName();
            //String url = ConfigApi.ipFrancisco + "/api/documento-almacenado/download/" + u.getCliente().getFoto().getCompleteFileName(); //Conexión con celular
