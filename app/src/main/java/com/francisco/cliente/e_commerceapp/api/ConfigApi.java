...
public class ConfigApi {
    public static final String baseUrlE = "http://10.0.2.2:9090"; //conexión al servicio
    //public static final String ipFrancisco = "http://10.32.113.158:9090";
    ...
    private static void initClient() {
        ...
        retrofit = new Retrofit.Builder()
                .baseUrl(baseUrlE)
                //.baseUrl(ipFrancisco) //para consumir con celular
