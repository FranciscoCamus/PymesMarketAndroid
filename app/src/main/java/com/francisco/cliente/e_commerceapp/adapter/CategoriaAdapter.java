...
import com.francisco.cliente.e_commerceapp.activity.ListarProductosPorCategoriaActivity;
...
public class CategoriaAdapter extends ArrayAdapter<Categoria> {
    ...
    //private final String url = ConfigApi.ipFrancisco + "/api/documento-almacenado/download/";
