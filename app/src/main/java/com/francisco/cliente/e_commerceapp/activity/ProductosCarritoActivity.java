...
import com.francisco.cliente.e_commerceapp.adapter.ProductoCarritoAdapter;
import com.francisco.cliente.e_commerceapp.communication.CarritoCommunication;
    ...
    private void registrarPedido(int idC) {
        ...
        this.pedidoViewModel.guardarPedido(dto).observe(this, response -> {
            if (response.getRpta() == 1) {
                ...
                toastIncorrecto("Error, No se pudo registrar el pedido!");
            }
        });
